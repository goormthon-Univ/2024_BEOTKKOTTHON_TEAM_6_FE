...
import 'package:rebook/binding/study_by_image_binding.dart';
...
import 'package:rebook/view/study_by_image/study_by_image_screen.dart';
...
List<GetPage> appPages = [
  ...
  GetPage(
    name: Routes.STUDY_BY_IMAGE,
    page: () => const StudyByImageScreen(),
    binding: StudyByImageBinding(),
  ),
];
